...
export const Footer: FC = () => {
    return (
        <div className="">
            <footer className="mx-auto flex flex-row p-2 text-center items-center footer bg-header text-neutral-content">
                <div className="pl-2">
                    <img
                ...
                <div className="max-w-md mx-auto sm:pl-12 grid-flow-col gap-4 text-center">
                    <a
                        rel="noreferrer"
                        href="https://twitter.com/oceanguardsNFT"
                        target="_blank">
                    ...
                    <a 
                        rel="noreferrer"
                        href="https://discord.gg/eq7dj5yD7V"
                        target="_blank">
